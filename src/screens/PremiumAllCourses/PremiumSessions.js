...
export default function PremiumSessions({navigation}) {
  const data = [
    {
      id: '1',
  ...
  const renderItem = ({item}) => {
    return (
      <SessionCards
        ...
        onPress={() => navigation.navigate('PremiumSessionInfo')}
      />
    );
  };
    ...
    <View style={styles.container}>
      ...
      <View style={styles.heading}>
        <Text style={styles.headingTxt}>
          COURCE SESSIONS <Text style={{color: color.light_grey}}>(1-50)</Text>
        </Text>
      </View>
