...
export default function PremiumLogin({navigation}) {
        ...
        <View style={styles.main_container}>
          ...
          <View style={styles.checkbox_row}>
            ...
            <TouchableOpacity
              activeOpacity={0.4}
              onPress={() =>
                navigation.navigate('PremiumForgetpassword', {
          ...
          <View style={styles.button_container}>
            <App_Button
              title={'login'}
              onPress={() => navigation.navigate('PremiumPaymentOption')}
            />
            ...
            <View style={styles.signup_row}>
              ...
              <TouchableOpacity
                onPress={() => navigation.navigate('PremiumSignup')}>
