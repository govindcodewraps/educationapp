...
const TrainerSignup = ({navigation, route, rdStoreUser}) => {
  const sub_type2 = route.params.select_type;  //localStorage.getItem('user_type');
  ...
  const ProcessSignUp = () => {
    ...
    if (valid) {
      ...
      // signUpData.append('user_type', 'trainer');
      ...
      var signUpData = qs.stringify({
        registration: '1',
        user_type: route.params.select_type,
        name: inputs.name,
      ...
      console.log('-------------------------------------------------');
      console.log('TrainerSignup.js, formdata : ', signUpData);
      ...
      axios
        ...
        .then(function (response) {
          ...
          if (response.data.success == 1) {
            ...
            navigation.navigate('TrainerOtp', {
            ...
            showMessage({
              message: 'Error',
              description: 'Trainer, '+response.data.message,
              type: 'default',
              backgroundColor: 'red',
            });
          }
